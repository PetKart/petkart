...
const PetsPage = () => {
  ...
  const stats = [
    { label: 'Number of Dogs', value: '40', color: 'text-purple-600' },
    { label: 'Number of Cats', value: '50', color: 'text-purple-600' },
    { label: 'Number of Fish', value: '90', color: 'text-purple-600' },
    { label: 'Daily Add Pets', value: '23', color: 'text-purple-600' }
  ];

  const tabs = ['All', 'Dog', 'Cat', 'Fish'];
